...
const SiteDetail = () => {
  ...
  const getCellColor = (totalBooked: number, isPending: boolean): string => {
    if (isPending) return "bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/20 dark:hover:bg-blue-900/30 cursor-pointer rounded-2xl border border-blue-300/50 dark:border-blue-500/30 shadow-sm hover:shadow-md transition-all duration-200";
