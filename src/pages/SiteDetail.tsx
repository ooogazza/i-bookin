...
const SiteDetail = () => {
  ...
  const getCellColor = (totalBooked: number, isPending: boolean): string => {
    if (isPending) return "bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/40 cursor-pointer rounded-xl border-2 border-blue-400/60 shadow-sm hover:shadow-md transition-all duration-200";
