            ...
            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {garageTypes.map(gt => (
                ...
                >
                  <div className="flex items-center gap-2">
                    <div className="p-2 rounded-lg bg-primary/10">
                      <img src={getGarageIcon(gt.garage_type)} alt={gt.garage_type} className="h-8 w-8 object-contain mix-blend-multiply dark:mix-blend-screen" />
                    </div>
                        ...
                        <tr className={`border-b transition-colors bg-muted/30 ${isHighlighted ? 'bg-primary/10' : ''}`}>
                          ...
                          >
                            <div className="flex items-center justify-center">
                              <img src={getGarageIcon(garageTypeConfig?.garage_type || garage.garage_type)} alt={garage.garage_type} className="w-8 h-8 object-contain mix-blend-multiply dark:mix-blend-screen" />
                            </div>
                          </td>
                          <td className="p-2">
